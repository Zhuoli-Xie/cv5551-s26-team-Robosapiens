...
class CubePoseDetector:
    ...
    def __init__(self, camera_intrinsic):
        ...
        self.color_ranges = {
            ...
            'red2':   ((170, 80, 50), (180, 255, 255)), # 红色的另一半跨度
    ...
    def get_transforms(self, observation, cube_prompt, t_cam_robot=None):
        ...
        if not target_color:
            print(f"无法从提示词中解析出支持的颜色: '{cube_prompt}'")
            return None
    ...
    try:
        ...
        if t_cam_robot is not None:
            ...
            if result is not None:
                ...
                print("can't find the cube pose.")
                return
        else:
            return
        # Visualization
